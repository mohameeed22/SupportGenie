...
class TestAnalytics:
    ...
    def test_record_escalation(self, test_user_id):
        ...
        session_store.upsert_user(test_user_id)
        session_store.record_escalation(test_user_id, reason="sentiment-trigger", source="ai-chat")
    ...
    def test_record_feedback(self, test_user_id):
        ...
        session_store.upsert_user(test_user_id)
        session_store.record_feedback(test_user_id, helpful=True, source="product-search")
...
class TestRateLimiting:
    def test_rate_limit_check_passes(self, test_user_id):
        ...
        limited = session_store.user_message_rate_limited(test_user_id, max_messages=5, window_seconds=60)
        assert not limited
