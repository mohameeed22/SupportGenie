...
from handlers.fallback import products_overview
...
from handlers.handoff import human_escalation
...
def main_menu_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("🗑 Clear Chat", callback_data="menu:clear"),
            ],
        ]
    )
...
async def menu_router(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if data == "menu:main":
        ...
        await query.answer()
        await query.edit_message_text("🧹 Chat cleared! How can I help?")
